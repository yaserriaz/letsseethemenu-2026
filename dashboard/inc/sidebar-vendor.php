...
<li class="dash-divider border-b">
  <a href="<?php echo htmlspecialchars($base, ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo dash_link_class(($dash_page ?? '') === 'index'); ?>">
    <span class="material-symbols-outlined text-[20px]">dashboard</span><span>Vendor Dashboard</span>
  </a>
</li>
<li class="dash-divider border-b">
...
<li class="dash-divider border-b">
  <button type="button" class="w-full flex items-center gap-3 px-4 py-3 text-sm text-left text-white" data-dash-accordion aria-expanded="<?php echo $openRestaurants ? 'true' : 'false'; ?>" aria-controls="dash-sub-restaurants">
  ...
  <div id="dash-sub-restaurants" class="dash-sub <?php echo $openRestaurants ? '' : 'hidden'; ?>">
...
<li class="dash-divider border-b">
  <button type="button" class="w-full flex items-center gap-3 px-4 py-3 text-sm text-left text-white" data-dash-accordion aria-expanded="<?php echo $openGifts ? 'true' : 'false'; ?>" aria-controls="dash-sub-gifts">
  ...
  <div id="dash-sub-gifts" class="dash-sub <?php echo $openGifts ? '' : 'hidden'; ?>">
...
<li class="dash-divider border-b">
  <button type="button" class="w-full flex items-center gap-3 px-4 py-3 text-sm text-left text-white" data-dash-accordion aria-expanded="<?php echo $openEvents ? 'true' : 'false'; ?>" aria-controls="dash-sub-events">
  ...
  <div id="dash-sub-events" class="dash-sub <?php echo $openEvents ? '' : 'hidden'; ?>">
