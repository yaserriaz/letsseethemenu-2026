...
$dash_user = 'vendor';
$dash_page = 'orders';
$page_title = 'My Orders - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">My Orders</h1>
    <p class="mt-2 text-on-surface-variant">Orders related to your venues and gift cards.</p>
  </div>
