...
$dash_user = 'vendor';
$dash_page = 'promote';
$page_title = 'Promote To Earn - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">Promote To Earn</h1>
    <p class="mt-2 text-on-surface-variant">Share your links and track promote-to-earn activity.</p>
  </div>
