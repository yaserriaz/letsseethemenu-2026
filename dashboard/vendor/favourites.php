...
$page_title = 'My Favourites - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">My Favourites</h1>
    <p class="mt-2 text-on-surface-variant">Saved restaurants and menus.</p>
  </div>
