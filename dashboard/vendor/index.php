...
$stats = [
    ...
    ['label' => 'Open banners', 'value' => '0', 'suffix' => 'campaigns', 'icon' => 'image', 'accent' => true],
];
...
$actions = [
    ...
    ['title' => 'Change Password', 'desc' => 'Keep your vendor account secure.', 'icon' => 'lock', 'href' => $base . 'password', 'warn' => false],
    ...
    ['title' => 'Gift Cards', 'desc' => 'Issue and manage venue gift cards.', 'icon' => 'card_giftcard', 'href' => $base . 'gift-cards', 'warn' => false],
...
$page_title = 'Vendor Dashboard - Let\'s See The Menu';
ob_start();
?>
<div class="max-w-6xl mx-auto">
  <section class="dash-rise relative overflow-hidden rounded-3xl mb-6 md:mb-8 bg-gradient-to-br from-[#0b2a5c] via-primary to-[#1a5bb8] text-white px-5 py-6 md:px-8 md:py-8">
    ...
    <div class="relative flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
      <div class="max-w-xl">
        <p class="text-xs uppercase tracking-[0.18em] text-white/70 font-semibold mb-2">Vendor console</p>
        ...
        <p class="text-white/80 text-sm md:text-base leading-relaxed">
          Manage venues, menus, banners, and events — without the affiliate earnings clutter.
        </p>
      </div>
  ...
  <section class="dash-rise dash-rise-delay-2">
    <div class="flex items-end justify-between gap-4 mb-4">
      ...
      <p class="hidden sm:block text-xs text-on-surface-variant max-w-xs text-right">Orange markers mean a setup step still needs attention.</p>
    </div>
