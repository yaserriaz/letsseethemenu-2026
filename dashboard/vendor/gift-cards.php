...
$page_title = 'Gift Cards - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">Gift Cards</h1>
    <p class="mt-2 text-on-surface-variant">Issue and manage gift cards for your venues.</p>
  </div>
