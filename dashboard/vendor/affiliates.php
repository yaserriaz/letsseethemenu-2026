...
$dash_user = 'vendor';
$dash_page = 'affiliates';
$page_title = 'Affiliates Details - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">Affiliates Details</h1>
    <p class="mt-2 text-on-surface-variant">View affiliate performance and referral details.</p>
  </div>
