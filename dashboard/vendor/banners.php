...
$dash_user = 'vendor';
$dash_page = 'banners';
$page_title = 'My Banners - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">My Banners</h1>
    <p class="mt-2 text-on-surface-variant">Create and manage advertising banners.</p>
  </div>
