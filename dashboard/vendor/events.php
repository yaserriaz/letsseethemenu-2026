...
$dash_user = 'vendor';
$dash_page = 'events';
$page_title = 'Manage Events - Vendor Dashboard';
ob_start();
?>
<div class="max-w-4xl">
  <div class="mb-6">
    <p class="text-xs uppercase tracking-wider text-primary font-bold mb-1">Vendor Dashboard</p>
    <h1 class="font-headline-md text-headline-md text-on-background">Manage Events</h1>
    <p class="mt-2 text-on-surface-variant">Create and manage sports voting events.</p>
  </div>
