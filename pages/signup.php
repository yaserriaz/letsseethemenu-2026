  ...
  <div class="max-w-[1140px] mx-auto">
    ...
    <div class="grid lg:grid-cols-[1fr_280px] gap-5 items-start">
      ...
      <div class="rounded-3xl border border-outline-variant/40 bg-surface-container-lowest p-6 md:p-8 shadow-sm">
        <form id="signup-form" action="<?php echo htmlspecialchars($sitepath, ENT_QUOTES, 'UTF-8'); ?>dashboard/" method="post" class="grid grid-cols-1 sm:grid-cols-2 gap-md" novalidate data-allow-submit="1">
        ...
        <p class="font-label-sm text-on-surface-variant text-center mt-lg">
          Already a member?
          <a href="login<?php echo $ref ? '?ref=' . $ref : ''; ?>" class="text-primary font-bold hover:underline">Login</a>
        </p>
      </div>
      ...
      <div class="sticky top-24 space-y-md">
        ...
        <div data-panel="customer"
          ...
          <a href="login<?php echo $ref ? '?ref='.$ref : ''; ?>"
