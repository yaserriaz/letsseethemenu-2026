...
<a href="single-restaurant" class="group block p-lg rounded-2xl border border-outline-variant/40 hover:border-primary transition-colors">
...
<a href="blog" class="group block p-lg rounded-2xl border border-outline-variant/40 hover:border-primary transition-colors">
...
<a href="page/affiliates" class="group block p-lg rounded-2xl border border-outline-variant/40 hover:border-primary transition-colors">
