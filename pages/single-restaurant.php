...
$body_class = 'font-body-md text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container';
$skip_main_nav = true;
$extra_head = '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fancyapps/ui/dist/fancybox.css">
<style>
...
$extra_footer = '<script src="https://cdn.jsdelivr.net/npm/@fancyapps/ui/dist/fancybox.umd.js"></script>
<script>
...
<button class="btn-iconed bg-primary text-white font-bold font-label-sm text-label-sm rounded-full px-6 py-2.5 active:scale-95 shadow-md hover:bg-primary-container hidden sm:inline-flex" type="button" onclick="location.href='login'">
...
<a class="hover:text-primary transition-colors ml-1 md:ml-2" href="available-states">States</a>
</div>
</li>
<li>
<div class="flex items-center">
<span class="material-symbols-outlined text-sm mx-1">chevron_right</span>
<a class="hover:text-primary transition-colors ml-1 md:ml-2" href="available-cities">Connecticut</a>
</div>
</li>
<li>
<div class="flex items-center">
<span class="material-symbols-outlined text-sm mx-1">chevron_right</span>
<a class="hover:text-primary transition-colors ml-1 md:ml-2" href="locations">Groton</a>
</div>
</li>
