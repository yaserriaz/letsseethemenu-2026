...
$body_class = 'bg-surface font-body-md text-on-surface antialiased overflow-x-hidden';
ob_start();
?>
<main>
...
<a href="single-restaurant" class="block">
...
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Italian</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Artisan</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Pizza</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Wood-Fired</a>
</div>
</article>
<article class="group bg-white rounded-xl overflow-hidden card-shadow hover:-translate-y-2 transition-all duration-300">
<a href="single-restaurant" class="block">
...
<div class="px-md pb-md flex flex-wrap gap-1">
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Mexican</a>
<a href="locations" class="bg-secondary-container/10 text-secondary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-secondary hover:text-white transition-colors">Trending</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Tacos</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Margaritas</a>
</div>
</article>
<article class="group bg-white rounded-xl overflow-hidden card-shadow hover:-translate-y-2 transition-all duration-300">
<a href="single-restaurant" class="block">
...
<div class="px-md pb-md flex flex-wrap gap-1">
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Japanese</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Fusion</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Sushi</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Ramen</a>
</div>
</article>
<article class="group bg-white rounded-xl overflow-hidden card-shadow hover:-translate-y-2 transition-all duration-300">
<a href="single-restaurant" class="block">
...
<div class="px-md pb-md flex flex-wrap gap-1">
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">BBQ</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Classic</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Smoked</a>
<a href="locations" class="bg-primary/10 text-primary text-[10px] leading-none px-1.5 py-1 rounded-full hover:bg-primary hover:text-white transition-colors">Texas</a>
</div>
</article>
</div>
<div class="mt-lg flex justify-center">
<a href="locations" class="btn-iconed bg-primary text-white font-bold rounded-full px-10 py-4 shadow-md hover:shadow-xl hover:bg-primary-container transition-all active:scale-95">
...
<a href="locations" class="btn-iconed bg-primary text-white font-bold font-label-sm rounded-full px-5 py-2.5 shadow-md hover:bg-primary-container shrink-0 no-underline hover:no-underline">
<span class="material-symbols-outlined">explore</span>
<span class="spn">View All</span>
</a>
</div>
<div class="flex gap-gutter overflow-x-auto pb-6 snap-x no-scrollbar">
<a href="single-restaurant" class="min-w-[280px] bg-white rounded-lg p-3 flex gap-4 card-shadow snap-start group cursor-pointer hover:bg-primary/5 transition-colors">
...
<a class="btn-iconed btn-iconed-outline text-primary font-bold font-label-sm no-underline hover:no-underline border border-transparent rounded-full px-3 py-1" href="blog">
...
<a href="category/travel-tips-and-guides/post/explore-groton-ct-s-best-kept-secrets" class="block">
...
<a href="category/travel-tips-and-guides/post/explore-groton-ct-s-best-kept-secrets" class="text-secondary font-label-xs uppercase tracking-widest mb-2 w-fit hover:underline">Trends</a>
<a href="category/travel-tips-and-guides/post/explore-groton-ct-s-best-kept-secrets" class="block">
...
<a href="category/travel-tips-and-guides/post/explore-groton-ct-s-best-kept-secrets" class="flex justify-between items-center mt-auto pt-4 border-t border-outline-variant/20 no-underline">
...
<article class="flex flex-col bg-white rounded-xl overflow-hidden card-shadow hover:-translate-y-1 transition-transform group">
<a href="category/lstm-picks/post/enterprise-rent-a-car-your-go-to-ride" class="block">
<div class="h-48 bg-cover bg-center" style="background-image: url('assets/img/petit-paris.jpg');"></div>
</a>
<div class="p-md flex-grow flex flex-col">
<a href="category/lstm-picks/post/enterprise-rent-a-car-your-go-to-ride" class="text-primary font-label-xs uppercase tracking-widest mb-2 w-fit hover:underline">Insights</a>
<a href="category/lstm-picks/post/enterprise-rent-a-car-your-go-to-ride" class="block">
...
<a href="category/lstm-picks/post/enterprise-rent-a-car-your-go-to-ride" class="flex justify-between items-center mt-auto pt-4 border-t border-outline-variant/20 no-underline">
...
<article class="flex flex-col bg-white rounded-xl overflow-hidden card-shadow hover:-translate-y-1 transition-transform group">
<a href="category/airbnb-host-tips/post/promote-rental-lstm" class="block">
<div class="h-48 bg-cover bg-center" style="background-image: url('assets/img/blog-patio.jpg');"></div>
</a>
<div class="p-md flex-grow flex flex-col">
<a href="category/airbnb-host-tips/post/promote-rental-lstm" class="text-tertiary font-label-xs uppercase tracking-widest mb-2 w-fit hover:underline">Local Guide</a>
<a href="category/airbnb-host-tips/post/promote-rental-lstm" class="block">
...
<a href="category/airbnb-host-tips/post/promote-rental-lstm" class="flex justify-between items-center mt-auto pt-4 border-t border-outline-variant/20 no-underline">
...
<a href="single-restaurant" class="flex items-center gap-2">
