...
<section class="mb-xl rounded-3xl bg-primary text-white p-xl relative overflow-hidden">
...
<a href="available-states.php" class="btn-iconed bg-primary text-white font-bold rounded-full px-6 py-3">
<span class="material-symbols-outlined">search</span>
<span class="spn">Browse Businesses</span>
</a>
<a href="become-a-sponsor.php" class="btn-iconed btn-iconed-outline border border-primary text-primary font-bold rounded-full px-6 py-3">
