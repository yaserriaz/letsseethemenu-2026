<?php
$page = 'locations';
$page_title = 'Menus in Austin - Let\'s See The Menu';
?>
<!DOCTYPE html>
...
<body class="bg-surface text-on-surface min-h-screen flex flex-col font-body-md antialiased overflow-x-hidden">
...
<span>/</span>
<a class="hover:text-primary transition-colors" href="available-cities.php">Texas</a>
<span>/</span>
<span class="text-on-surface font-semibold">Austin</span>
</nav>
<div class="mt-lg">
<?php include __DIR__ . '/inc/search-bar.php'; ?>
</div>
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter mb-xl">
<a href="single-restaurant.php" class="bg-white rounded-xl overflow-hidden card-shadow card-hover flex flex-col relative group cursor-pointer border border-outline-variant/20">
