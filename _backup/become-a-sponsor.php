...
<a href="contact.php" class="btn-iconed bg-primary text-white font-bold rounded-full px-6 py-3">
<span class="material-symbols-outlined">rocket_launch</span>
<span class="spn">Become a Sponsor</span>
</a>
<a href="how-it-works.php" class="btn-iconed btn-iconed-outline border border-primary text-primary font-bold rounded-full px-6 py-3">
...
<p class="font-body-md text-on-surface-variant leading-relaxed max-w-3xl">Your payment method is securely stored when you register — but no charge is ever made upfront. A small platform service fee is only applied when a winning customer actually redeems their prize at your location. No redemptions = no charges.</p>
</section>
<section class="mb-xl">
