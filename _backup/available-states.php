...
<a class="group relative rounded-xl overflow-hidden aspect-[4/3] bg-surface-container shadow-[0_2px_8px_rgba(0,68,150,0.1)] transition-all duration-300 state-card-hover block" href="available-cities.php">
