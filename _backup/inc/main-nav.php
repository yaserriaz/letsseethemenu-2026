...
<a class="<?php echo $page === 'single-restaurant' ? $nav_active : $nav_pill; ?>" href="single-restaurant.php" title="Try a Demo">
<span class="material-symbols-outlined">restaurant</span>
<span class="spn">Try a Demo</span>
</a>
<a class="<?php echo $page === 'available-states' ? $nav_active : $nav_pill; ?>" href="available-states.php" title="Search by State">
<span class="material-symbols-outlined">location_on</span>
<span class="spn">Search by State</span>
</a>
<a class="<?php echo $page === 'blog' ? $nav_active : $nav_pill; ?>" href="blog.php" title="Blog">
<span class="material-symbols-outlined">edit</span>
<span class="spn">Blog</span>
</a>
<a class="<?php echo $nav_login; ?>" href="login.php" title="Login">
