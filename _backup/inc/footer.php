...
<ul class="space-y-4">
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="mission-statement.php">Mission Statement</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="how-it-works.php">How it works</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="contact.php">Contact</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="blog.php">Blog</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="local-events.php">Local Events</a></li>
</ul>
</div>
<div>
<h4 class="text-white font-headline-md font-bold mb-6">Info</h4>
<ul class="space-y-4">
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="terms-condition.php">Terms &amp; condition</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="privacy-policy.php">Privacy Policy</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="affiliates.php">Affiliates</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="become-a-sponsor.php">Become a Sponsor</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="delivery-information.php">Delivery Information</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="refund-policy.php">Refund policy</a></li>
<li><a class="text-surface-variant hover:text-primary-fixed-dim transition-colors font-body-md" href="user-data-deletion.php">User Data Deletion</a></li>
</ul>
</div>
<div>
...
<a class="text-surface-variant hover:text-white font-label-xs transition-colors" href="privacy-policy.php">Privacy Policy</a>
<a class="text-surface-variant hover:text-white font-label-xs transition-colors" href="terms-condition.php">Terms of Service</a>
<a class="text-surface-variant hover:text-white font-label-xs transition-colors" href="legal-disclaimer.php">Legal Disclaimer</a>
</div>
</div>
</div>
</footer>
...
<a class="flex flex-col items-center justify-center bg-primary-container text-on-primary-container rounded-full px-4 py-1 scale-90 transition-all duration-200" href="available-states.php">
...
<a class="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-variant p-2 rounded-lg" href="favorites.php">
<span class="material-symbols-outlined mb-1">favorite</span>
<span class="font-label-xs text-label-xs">Favorites</span>
</a>
<a class="flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-variant p-2 rounded-lg" href="profile.php">
...
(function () {
  ...
  function initForm(form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (ok) {
        /* All valid — add your AJAX / fetch call here */
      }
    });
  }
